...
namespace Evernote.EDAM.NoteStore
{
  ...
  [Serializable]
  #endif
  public partial class RelatedNotesScoreDoc : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("RelatedNotesScoreDoc");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("RelatedNotesScoreDoc(");
      sb.Append("Note: ");
